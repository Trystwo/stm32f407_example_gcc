...
#define LV_MEM_CUSTOM                       0
    ...
    #define LV_MEM_SIZE                     (46U * 1024U)          /*[�ֽ�]*/

    /* Ϊ�ڴ������һ����ַ�������ǽ�����Ϊ��ͨ������䡣Ҳ�������ⲿSRAM�С� */
    #define LV_MEM_ADR                      0     /*0: δʹ��*/
    /* ���ڴ�����������ǵ�ַ�����������������LVGL���ڴ�ء�����my_malloc */
    #if LV_MEM_ADR == 0
        #define LV_MEM_POOL_INCLUDE "malloc.h"  /* ���ʹ���ⲿ��������ȡ��ע�� */
        #define LV_MEM_POOL_ALLOC   lv_mymalloc          /* ���ʹ���ⲿ��������ȡ��ע�� */
    #endif

#else       /*LV_MEM_CUSTOM*/
    #define LV_MEM_CUSTOM_INCLUDE "malloc.h"   /* ��̬�ڴ溯����ͷ */
